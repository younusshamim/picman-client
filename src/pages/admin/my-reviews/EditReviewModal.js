...
const EditReviewModal = ({
  ...
  return (
    <>
      <input type="checkbox" id="edit-modal-3" className="modal-toggle" />
      <div className="modal">
        <div className="modal-box relative py-10">
          <label
            htmlFor="edit-modal-3"
            className="btn btn-sm btn-circle absolute right-2 top-2"
            // onClick={() => setReviewDetails(initReviewDetails)}
          >
            ✕
          </label>
          ...
          {user ? (
            ...
            >
              ...
              ></textarea>
              <input type="submit" value="Edit Submit" className="btn w-full" />
            </form>
          ) : (
            <>
